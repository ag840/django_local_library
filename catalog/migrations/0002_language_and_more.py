# Generated by Django 4.2.20 on 2025-04-27 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. English, Spanish, Farsi, etc.)", max_length=20, unique=True)),
            ],
        ),
